...
function zag_unpublish_buy_prop_ajax_action() {
    ...
    if (!$current_post->post_author == $current_user->ID || 0 == $current_user->ID || !check_ajax_referer('edit_buy_nonce', 'coming_unpublish_buy_nonce', false)) {
