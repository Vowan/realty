...
function zag_trash_project_prop_ajax_action() {
    ...
    if (!$current_post->post_author == $current_user->ID || 0 == $current_user->ID || !check_ajax_referer('edit_project_nonce', 'coming_delete_project_nonce', false)) {
