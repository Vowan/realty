 ...
 */
class Zag_See_Sell_Property_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'Zag_See_Sell_Property_Widget', // Base ID
                __('Zag_See_Sell_Property_Widget', 'text_domain'), // Name
                array('description' => __('Zag_See_Sell_Property_Widget!', 'text_domain'),) // Args
        );
    }
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="well panel-primary" style="text-align: center;"><h3>Продам</h3>
                                    ...
                                    <?php foreach ($photo_files as $index => $photo): ?>
                                        <div class="item <?php if (0 == $index) echo 'active'; ?>">
                                            ...
                                            <div class="carousel-caption">
                                                <h3><?= $room[$index] ?></h3><h3 style="color: yellow"><?= $roomSQ[$index] ?> м2</h3>
                                            </div>
                                        </div>
