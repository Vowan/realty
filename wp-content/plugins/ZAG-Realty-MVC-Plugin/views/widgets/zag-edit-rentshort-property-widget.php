 ...
 */
class Zag_Edit_Rent_Short_Property_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'Zag_Edit_Rent_Short_Property_Widget', // Base ID
                __('Zag_Edit_Rent_Short_Property_Widget', 'text_domain'), // Name
                array('description' => __('Zag_Edit_Rent_Short_Property_Widget!', 'text_domain'),) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        <div class="container-fluid">
            <form id="edit-shortrent-form">
                 ...
                 <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row" style="text-align: center;">
                            <h2>Редактировать -"Сдам посуточно"</h2>
                ...
                ?>
                <br>
                <button id="zag-edit-rentshort-prop" type="button" class="btn btn-primary">Сохранить редактирование</button>
                <button id="zag-unpublish-rentshort-prop" type="button" class="btn btn-warning">В архив</button>
                <button id="zag-delete-rentshort-prop" type="button" class="btn btn-danger">Удалить</button>
