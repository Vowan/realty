 ...
 */
class Zag_See_Rent_Rever_Property_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'Zag_See_Rent_Rever_Property_Widget', // Base ID
                __('Zag_See_Rent_Rever_Property_Widget', 'text_domain'), // Name
                array('description' => __('Zag_See_Rent_Rever_Property_Widget!', 'text_domain'),) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h2 style="margin: 0 auto;">Cмотреть Сниму
                    </h2>
                </div>
                <div class="col-sm-4"></div>
            </div>
