 ...
 */
class Zag_Creat_New_Rent_Short_Property_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'Zag_Creat_New_Rent_Short_Property_Widget', // Base ID
                __('Zag_Creat_New_Rent_Short_Property_Widget', 'text_domain'), // Name
                array('description' => __('Zag_Creat_New_Rent_Short_Property_Widget!', 'text_domain'),) // Args
        );
    }
      ...
      public function widget($args, $instance) {
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h2 style="margin: 0 auto;">Сдам посуточно
                    </h2>
                </div>
                <div class="col-sm-4"></div>
            </div>
                ...
                <div class="col-sm-6">
                    ...
                    <form id="new-shortrent-form">
                        ...
                        <section id="all-rooms">
                            ...
                            <button id="rentshortRoomButton" type="button" class="btn btn-primary">Добавить  комнату</button>
                        ...
                        ?>
                        <br>
                        <button id="zag-new-rentshort-prop" type="button" class="btn btn-primary">Submit</button>
