 ...
 */
class Zag_See_Hostel_Property_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'Zag_See_Hostel_Property_Widget', // Base ID
                __('Zag_See_Hostel_Property_Widget', 'text_domain'), // Name
                array('description' => __('Zag_See_Hostel_Property_Widget!', 'text_domain'),) // Args
        );
    }
