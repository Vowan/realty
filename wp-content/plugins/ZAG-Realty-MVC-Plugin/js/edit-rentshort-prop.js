jQuery(function ($) {
    ...
    /********************************* form  edit submit********************************************/
    $("#zag-edit-rentshort-prop").click(function (e) { 


        // check if the input is valid
        $("#edit-shortrent-form").validate({
            rules: {
                user_first_name: {
                    required: true,
                    maxWords: 1,
        ...
        $("#edit-shortrent-form").trigger('submit.edit');
    })

    $('#edit-shortrent-form').on('submit.edit', function (e) {
        e.preventDefault();
        ...
        formData.append('action', 'zag_edit_shortrent_prop_ajax_action');
    ...
    $("#zag-unpublish-rentshort-prop").click(function (e) { 


        $("#edit-shortrent-form").trigger('submit.unpublish');
    })

    $('#edit-shortrent-form').on('submit.unpublish', function (e) {
        e.preventDefault();
        ...
        formData.append('action', 'zag_unpublish_shortrent_prop_ajax_action');
        formData.append('my_nonce', ajax_object.ajax_nonce);
  ...
  /********************************* form  trash submit********************************************/
    $("#zag-delete-rentshort-prop").click(function (e) { 


        $("#edit-shortrent-form").trigger('submit.trash');
    })

    $('#edit-shortrent-form').on('submit.trash', function (e) {
        e.preventDefault();
        ...
        formData.append('post_id', $('#post_id').val());
        formData.append('action', 'zag_trash_shortrent_prop_ajax_action');
        formData.append('my_nonce', ajax_object.ajax_nonce);
