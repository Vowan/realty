jQuery(function ($) {
    ...
    $("#rentlongRoomButton").click(function (e) { 
    ...
    $("#zag-new-rentlong-prop").click(function (e) { 


        // check if the input is valid
        $("#new-longrent-form").validate({
            rules: {
                user_first_name: {
                    required: true,
                    maxWords: 1,
        ...
        $("#new-longrent-form").trigger('submit');
    })

    $('#new-longrent-form').on('submit', function (e) {
        e.preventDefault();
        ...
        $('#new-longrent-form input[type="file"]').each(function (index) {
        ...
        formData.append('action', 'zag_new_longrent_prop_ajax_action');
    ...
    $('#shot_title').val(function (index, value) {
        return $('#rooms').val() + ' - комнатная квартира.  $' + $('#cost_US').val() + ' в месяц'
    });
